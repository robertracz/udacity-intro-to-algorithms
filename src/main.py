...
from vector_tests import VectorTests
...
def create_tour(nodes):
    ...
    res.append((nodes[len(nodes) - 1], nodes[0]))
...
def main():
    #a = test()
    #print(a)
    #VectorTests.test_magnitude()
    #VectorTests.test_angles()
    #VectorTests.test_parallel_orthogonal()
    #VectorTests.test__projection()
    VectorTests.test__cross_product()
